...
$sql = "INSERT INTO myform (name, email,state,district,city,venue,phone,date,message,evtype,guests) VALUES ('$name', '$email', '$state', '$district', '$city', '$venue', '$phone', '$date', '$message', '$event_type', '$guests')";
